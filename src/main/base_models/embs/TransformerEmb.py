...
from main.base_models.architectures.TransformerEncoder import TransformerEncoder

from main.utils.util import device


class TransformerEmb(SetFieldEmb):
    ...
    def __init__(self, vocab_size, num_layers, model_dim, ff_dim, num_heads, dropout_rate):
        ...
        self.transformer = TransformerEncoder(vocab_size, int(num_layers), int(model_dim), int(ff_dim), \
