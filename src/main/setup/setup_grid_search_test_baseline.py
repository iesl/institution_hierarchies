...
def setup_grid_search(exp_dir, grid_search_config, gpu_type_one, num_gpu_type_one, gpu_type_two, num_gpu_type_two, mem):
    '''
...
if __name__ == "__main__":
    ...
    parser.add_argument("-n2", "--num_gpu_type_two", default=None)
    ...
    setup_grid_search(exp_dir, grid_search_config, args.gpu_type_one, args.num_gpu_type_one, args.gpu_type_two, args.num_gpu_type_two, args.mem)